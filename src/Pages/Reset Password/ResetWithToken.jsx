...
import { ResetUserWithToken } from '../../Helper/userApi';
function ResetWithToken() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await ResetUserWithToken(user)
...
<div >
                ...
                <form action="" onSubmit={handleSubmit}  style={{ display: 'flex', flexDirection: "column", width: "30%", margin: "auto", marginTop: "20px" }}>
                    ...
                    <input type="password" ref={new_password} style={{ margin: "20px" }} placeholder='Enter New Password' required />
